...
def home(
    ...
    # total = sum(
    #     len([x for x in c["competence"] if isinstance(x, dict)])
    #     for c in data
    # )
    ...
    <div class="container mt-4">
        ...
        <div class="alert alert-info fw-bold">
            Échelle de notation : Survoler les champs niveau, niveau attenu et appétence pour voir les légendes.
        </div>
    ...
    for c in data:
        ...
        if c["competence"] and isinstance(c["competence"][0], str):
    
            c["competence"] = [
                {
                    "nom": comp,
                    "niveau": c.get("niveau", 1),
                    "niveau_attendu": c.get("niveau_attendu", 1),
                    "appetence": c.get("appetence", 1)
                }
                for comp in c["competence"]
            ]
        ...
        for index, comp in enumerate(c["competence"]):
            ...
            html += f"""
                ...
                <td onclick="event.stopPropagation()">
                    ...
                    <a
                        href="/edit/{c['id']}?competence={comp['nom']}"
                        class="btn btn-warning btn-sm"
                    >
                        ✏️
                    </a>
...
def add(
    ...
    log_action(user, "AJOUT", f"{prenom} {nom} {profil} {agence}")
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input
                            ...
                            max="5"
                            name="niveau_attendu"
                            value="{comp.get('niveau_attendu', 0)}"
                        >
                        ...
                        "".join([
                            ...
                            <div class="form-check">
                                <input class="form-check-input"
                                    ...
                                    {"checked" if skill in competences_selectionnees else ""}>
