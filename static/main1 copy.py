...
from static.modellllllls import Collaborateur
from static.modellllllls import Base
...
# =========================
# API REST - COLLABORATEURS
# =========================
@app.get("/api/collaborateurs")
def api_get_collaborateurs(request: Request):
    user = get_current_user(request)
